...
// values to gather.
type Dot func(x []float64, indx []int, y []float64) float64
...
func Dot4a(x []float64, indx []int, y []float64) (dot float64)
...
func Dot6a(x []float64, indx []int, y []float64) (dot float64)
...
func Dot7a(x []float64, indx []int, y []float64) (dot float64)
